function verdatos(){
    ...
    var url="http://localhost:5000/listmindivi";
    var data = {
...
info=info +"<img src='https://librerialerner.vteximg.com.br/arquivos/ids/405279-492-492/9788493462567-es.jpg?v=637395856039600000' class='card-img-top' alt='...'>"    
...
info=info+"<li class='list-group-item'> Libro Físico </li>"
info=info+"<li class='list-group-item'> La Voz Maligna <span class='badge bg-primary rounded-pill'>20</span></li>"
info=info+"</ul>"
info=info+"<a href='{{url_for('gestionProducto')}}' class='btn btn-primary'>Ver Producto</a>"
info=info+"</div>"
info=info+"</div>"
}
...
function list_deseos(){
    ...
    info=info+"<ul class='list-group list-group-flush'>"
    info=info+"<li class='list-group-item'> Libro Físico </li>"
    info=info+"<li class='list-group-item'> La Voz Maligna <span class='badge bg-danger rounded-pill'>20</span></li>"
    info=info+"</ul>"
    info=info+"<a href='{{url_for('gestionProducto')}}' class='btn btn-danger'>Ver Producto Deseado</a>"
    info=info+"</div>"
    info=info+"</div>"
    }
